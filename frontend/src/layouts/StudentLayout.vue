  ...
  <el-container class="layout-container">
    ...
    <el-aside :width="isCollapse ? '64px' : '200px'" class="layout-aside">
      <div class="logo-container">
        <h2 v-if="!isCollapse" class="logo-title">助教平台</h2>
        <h2 v-else class="logo-title-collapsed">TA</h2>
      </div>
      ...
      >
        ...
        <template v-if="userStore.isTA">
          <el-sub-menu index="ta">
            <template #title>
              <el-icon><Star /></el-icon>
              <span>助教功能</span>
            </template>
            <el-menu-item index="/ta/timesheets">工时管理</el-menu-item>
            <el-menu-item index="/ta/salaries">薪酬记录</el-menu-item>
          </el-sub-menu>
        </template>
      </el-menu>
    </el-aside>
